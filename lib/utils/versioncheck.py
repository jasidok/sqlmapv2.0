...
if PYVERSION < "3.11":
    sys.exit(
        "[%s] [CRITICAL] incompatible Python version detected ('%s'). To successfully run sqlmap you'll have to use version 3.11 or higher (visit 'https://www.python.org/downloads/')" % (
